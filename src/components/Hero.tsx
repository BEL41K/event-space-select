...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[90vh] min-h-[600px] flex items-center">
      ...
      <div className="container mx-auto px-4 md:px-6 z-10 relative">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-slide-up">
            <Button 
              className="bg-gold-500 hover:bg-gold-600 text-blue-950 text-base px-6 py-6 rounded-md"
            ...
            <Button 
              variant="outline" 
              className="border-white text-white hover:bg-white/10 text-base px-6 py-6 rounded-md"
            >
              Связаться с нами
            </Button>
          </div>
